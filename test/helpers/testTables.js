...
export const HIRA_KATA_TO_ROMA = [
  ...
  ['ぐんま', 'gunma', 'gunma'],
  ['かんい', "kan'i", "kan'i"],
  ['しんよう', "shin'you", "shin'you"],
  // double consonants
  ['あった', 'アッタ', 'atta'],
  ['がっこうなかった', 'ガッコウナカッタ', 'gakkounakatta'],
  ['けっか', 'kekka', 'kekka'],
  ['さっさと', 'sassato', 'sassato'],
  ['ずっと', 'zutto', 'zutto'],
  ['きっぷ', 'kippu', 'kippu'],
  ['ざっし', 'zasshi', 'zasshi'],
  ['いっしょ', 'issho', 'issho'],
  ...
  // hira long vowels
  ['がっこう', 'gakkou', 'gakkou'],
  ['とうきょう', 'toukyou', 'toukyou'],
  ['べんきょう', 'benkyou', 'benkyou'],
  ['でんぽう', 'denpou', 'denpou'],
  ['きんようび', "kin'youbi", "kin'youbi"],
  ['こうし', 'koushi', 'koushi'],
  // kata long vowels
  ['セーラー', 'seeraa', 'seeraa'],
  ['パーティー', 'paateii', 'paateii'],
  ['ヒーター', 'hiitaa', 'hiitaa'],
  ['タクシー', 'takushii', 'takushii'],
  ['スーパーマン', 'suupaaman', 'suupaaman'],
  ['バレーボール', 'bareebouru', 'bareebouru'],
  ['ソール', 'souru', 'souru'],
];
